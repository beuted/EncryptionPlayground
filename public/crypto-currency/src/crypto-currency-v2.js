define(["require", "exports", "./crypto-currency-v1"], function (require, exports, crypto_currency_v1_1) {
    ...
    class NetworkV2 extends crypto_currency_v1_1.Network {
        constructor() {
            super();
        }
        ...
        GenerateGenesisTransaction() {
            var genesisTranaction = super.GenerateGenesisTransaction();
    ...
    class UserV2 extends crypto_currency_v1_1.User {
        ...
        GetSignedMessageWithSerialNumber(receiver, amount, date) {
            ...
            let signedMessage = this.GetSignedMessage(receiver, amount, date);
            // Add a hash to it
            var md = new KJUR.crypto.MessageDigest({ alg: "sha256", prov: "cryptojs" });
        ...
        HashMatchAnotherHash(hash) {
            return this.localSignedMessages.findIndex((x) => x.hash == hash) !== -1;
        }
...
//# sourceMappingURL=crypto-currency-v2.js.map