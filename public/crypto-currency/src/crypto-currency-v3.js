define(["require", "exports", "./crypto-currency-v2"], function (require, exports, crypto_currency_v2_1) {
    ...
    class NetworkV3 extends crypto_currency_v2_1.NetworkV2 {
        constructor() {
            super();
        }
        BroadcastTransactionValidationToUser(name, validatorName, messageHash, signedMessageHash) {
    ...
    class UserV3 extends crypto_currency_v2_1.UserV2 {
        constructor(name, privateKey, network) {
            super(name, privateKey, network);
            this.localTransactionValidators = {};
        }
        // Public
        VerifySignedMessageAndAddToSignedMessageList(signedMessage) {
        ...
        ReceiveTransactionValidation(validatorName, messageHash, signedMessageHash) {
            ...
            if (this.localTransactionValidators[messageHash].findIndex((name) => name == validatorName) == -1)
